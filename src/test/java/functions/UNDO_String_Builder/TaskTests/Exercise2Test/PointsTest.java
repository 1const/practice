...
import functions.Tasks.Exercise1.Points;
...
public class PointsTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Points.vectorProduct(firstPoint2, secondPoint2).x + " "
                + Points.vectorProduct(firstPoint2, secondPoint2).y + " " + Points.vectorProduct(firstPoint2, secondPoint2).z);
